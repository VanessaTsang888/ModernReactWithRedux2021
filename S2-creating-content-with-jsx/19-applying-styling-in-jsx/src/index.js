...
Now works in Chrome - with the red underline feature.
****************************************************************************************/
function App() {
  return <input spellCheck={true} style={{ border: "1px sold blue" }} />;
  // Use lower camel-cased naming convention. Otherwise will get error when we inspect the UI -> Console tab.
  // <input maxLength="5" />
  // For the spellCheck Prop, this is a short-hand for: <input spellCheck={true} />;
